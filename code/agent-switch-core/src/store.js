...
// <root>/<session>/NNNN.json (default ~/.agent-switch/sessions/<project-key>/).
...
// ---- shared helpers also used by `agent-switch view` (no live store) ------------
...
// and best-effort: a read-only root (e.g. a legacy ./.agent-switch) is silently skipped
